...
export function Container({Data,}) {
  ...
  return (
    Data.map((vid) => (
      <div key={vid._id} onClick={() => handleVideoLoading(vid._id)} className="w-full h-[30vh] lg:h-[45vh] lg:p-2 hover:bg-primary-foreground rounded-2xl">
        <div className="h-[70%]">
        ...
        <div className="h-[30%] w-[100%] flex">
          <div className="h-[100%] w-[20%] flex items-center justify-start">
            <img className="w-15 h-15 lg:h-12 lg:w-12 rounded-full cursor-pointer object-cover border-card border-2" src={vid.thumbnail} alt="" />
          </div>
